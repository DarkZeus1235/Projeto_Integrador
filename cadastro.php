...
if (isset($_POST['bt_nome'])) {
  ...
  /*----------------------------------*/
  $result = $mysqli->query("INSERT INTO cadastro (email, senha, nome, telefone, username, cpf, endereco ) values('$email', '$senha', '$nome', '$telefone', '$username' ,'$cpf', '$endereco')") or
    die($mysqlierrno);

  if ($result) {
    $mensagem = 'Cadastro criado com sucesso!';
  } else {
    $mensagem = 'Erro ao criar o cadastro. Tente novamente.';
  }
}
?>
<!DOCTYPE html>
      ...
      <script>
        ...
        document.getElementById('cadastro').addEventListener('submit', function (e) {
            ...
            $.ajax({
                ...
                data: $('#cadastro').serialize(), // Use serialize para coletar todos os dados do formulário

...
if (isset($_POST['bt_nome'])) {
    ...
    if ($deucerto) {
        $mysqli->query("INSERT INTO cadastro_vodka (nome_bebida, quantidade, descricao,arquivo_caminho, valor) 
...
<body>
    ...
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <a class="btn btn-primary" href="lista_vodka.php">Bebidas</a>

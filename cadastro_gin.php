...
if (isset($_POST['bt_nome'])) {
    ...
    if ($deucerto) {
        $mysqli->query("INSERT INTO cadastro_gin (nome_bebida, quantidade, descricao,arquivo_caminho, valor) 
...
<body>
    ...
    <div class="container">
        <h1>Cadastro de Gin - Taverna de Valhalla</h1>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <a class="btn btn-primary" href="lista_gin.php">Bebidas</a>

...
<html lang="en">
    ...
    <div id="quad">
        ...
        <p class="text-fornec">Vendido por <span class="span-fornec">TAVERNA DE VALHALLA</span> <span id="text-vend">+6500 vendas</span></p>

        <div class="star-icon">
          <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i class="bi bi-star-half"></i> <p class="text-numb">(284)</p>
        </div>
        ...
        <h4><span class="span-comp">Valor:</span> <?php echo $bebidas['valor'];?>  <span class="text-x">em até 4x de R$50,00 sem juros.</span></h4>
        <button type="button" id="botao-frete" class="btn btn-warning">Calcular Frete</button>
        <button type="button" id="botao-comp" class="btn btn-success">Comprar agora</button>
    ...
    <div class="faixa-contact"></div>
    <svg id="insta" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
    ...
    <h3 class="insta">@taverna_valhalla</h3>
    <div class="space"></div>
    <svg id="face" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
      <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"></path>
    </svg>
    <h3 class="face">Taverna de Valhalla</h3>
    <div class="space"></div>
    <svg id="zap" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
    ...
    <h3 class="zap">(43) 99650-6831</h3>
    <div class="space"></div>
    <svg id="mail" xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">

...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>Lista de Champagne</title>
    </head>
    ...
    <ul>
      ...
      <div class="sair">
        ...
        <div class="container">
                ...
                <tr>
                    <?php
                       ...
                       <tr>
                        ...
                        <td><a class="btn btn-danger" href="deletar_champ.php?codigo_bebida=<?php echo $bebidas['id_champ']; ?>">Deletar</a></td>
                    </tr>
                    <?php
                    }
            ...
            <a class="btn btn-warning" href="cadastro_champ.php">Voltar para Cadastro de Champagne</a>
        </div>
    </body>
